...
Public docs should not include mail secrets, deployment credentials, private contact handling details, raw provider responses, or unpublished parity artifacts.
